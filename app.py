...
def render_location_consulting_ui(store_name, store_type, address):
    ...
    if any(k in addr_str for k in ['지하', '지하상가', '역사', '역내']):
        ...
        details = {
            ...
            * **가시성 및 시인성:** 보행 동선 정면에 위치하여 접근성은 뛰어난 편이나 지하 구조 특성상 전면 노출은 다소 제한됩니다.
            """,
            "배후 수요성": """
            * **배후 거주 세대:** 반경 500m 내 거주 세대보다 통행 유동인구 비중이 압도적인 이동형 상권입니다.
            * **소비 타깃층 분석:** 2030 직장인 및 통학 학생 비중이 높아 1만~2만원대 가성비 컬러렌즈 및 원데이 제품 선호도가 높습니다.
            """,
            "집객력·활성화": """
            * **매출 활성화도:** 단위 면적당 발자국(Foot Traffic)이 높으며, 퇴근 시간대(17시~20시) 결제 집약도가 매우 큽니다.
            """,
            "경쟁성·희소성": """
            * **경쟁점 밀집도:** 동일 구역 내 안경원 및 렌즈 전문점 밀집도가 높아 전용 PB 라인업 중심의 브랜드 차별화가 필수적입니다.
            """,
            "입지 안정성": """
            * **손익 관리:** 고정 임대료 비율을 상쇄할 수 있도록 원가율이 낮은 PB 컬러렌즈 판매 비중을 상향 유지를 권장합니다.
            """
        }
        ...
        details = {
            "유동성·접근성": """
            * **입지 특성 및 보행 동선:** 메인 대로변 입지로 지하철역 출입구 및 버스 정류장 접면성과 전면 간판 가시성이 최상위 수준입니다.
            """,
            "배후 수요성": """
            * **배후 수요 융합도:** 오피스 직장인과 주말 외부 유입 인구가 복합되어 미용 렌즈 및 기능성 렌즈 수요층이 두텁습니다.
            """,
            "집객력·활성화": """
            * **주중/주말 매출 균형:** 주중 퇴근 수요와 주말 약속/데이트 방문객 수요가 균형을 이루어 매출 기복이 적습니다.
            """,
            "경쟁성·희소성": """
            * **경쟁 과열 수준:** 주변 경쟁점이 다수 위치하므로 정밀 시력 검안 서비스 및 멤버십 단독 혜택으로 고객을 선점하세요.
            """,
            "입지 안정성": """
            * **손익 관리:** 높은 임대료 비중을 극대화된 매출로 극복할 수 있도록 마진율 중심의 품목 믹스가 필요합니다.
            """
        }
        ...
        details = {
            ...
            * **보행 동선 특성:** 대학가 메인 상권 로드샵 및 등하교 핵심 동선에 위치하여 청년층 보행 유동이 집중됩니다.
            """,
            "배후 수요성": """
            * **타깃 인구 밀도:** 1020세대 대학생 및 자취생 밀도가 압도적이며, SNS 이슈 제품 및 가성비 렌즈 선호도가 높습니다.
            """,
            "집객력·활성화": """
            * **학기 중 집객 폭발력:** 개강 시즌 매출은 폭발적이나, 방학 기간 유동 감소 대비 단골 DB 확보가 요구됩니다.
            """,
            "경쟁성·희소성": """
            * **차별화 방안:** 렌즈미 고유의 인기 PB 렌즈 입소문 마케팅과 학생 할인 프로모션이 효과적입니다.
            """,
            "입지 안정성": """
            * **트렌드 주기 리스크:** 영타겟 유행 주기가 빠른 상권 특성상 매장 디스플레이의 주기적 갱신이 필요합니다.
            """
        }
    else:
        ...
        details = {
            "유동성·접근성": """
            * **보행 및 차량 접근성:** 아파트 단지 입구 및 생활 밀착형 동선에 접해 있어 거주민 도보 접근성이 안정적입니다.
            """,
            "배후 수요성": """
            * **배후 거주 세대 밀도:** 대단지 아파트 밀집 지역으로 초중고 학생 및 3040 거주민 중심 단골층이 견고합니다.
            """,
            "집객력·활성화": """
            * **재방문 목적 구매:** 정기 교체 단골 비중이 높아 정밀 시력 검안 서비스 제공 시 고객 충성도가 극대화됩니다.
            """,
            "경쟁성·희소성": """
            * **상권 내 독점력:** 신규 대형 경쟁점 진입 가능성이 낮아 지역 커뮤니티 마케팅 적용 시 상권 독점이 쉽습니다.
            """,
            "입지 안정성": """
            * **장기 점포 운영:** 경기 변동 영향이 적어 장기적이고 예측 가능한 고정 수익 창출에 최적화된 입지입니다.
            """
        }
