...
def render_location_consulting_ui(store_name, store_type, address):
    ...
    if any(k in addr_str for k in ['지하', '지하상가', '역사', '역내']):
        ...
        details = {
            "유동성·접근성": """
            • <b>입지 특성 및 보행 동선:</b> 지하철 출입구 및 지하상가 메인 통로에 접해 있어 출퇴근시간대(08~09시, 18~20시) 유동인구 집약도가 매우 우수합니다.<br>
            • <b>가시성 및 시인성:</b> 보행 동선 정면에 위치하여 접근성은 뛰어나나, 지하 구조의 한계로 인해 지상 전면 노출 및 간판 시인성은 제한됩니다.<br>
            • <b>핵심 개선 포인트:</b> 입구 전면부에 조명형 렌즈 픽업 진열대를 설치하여 유동객의 시선을 즉각적으로 사로잡는 전략이 유효합니다.
            """,
            "배후 수요성": """
            • <b>배후 거주 세대:</b> 반경 500m 내 주거용 아파트 세대수보다 통행 유동인구 비중이 압도적인 이동형 상권입니다.<br>
            • <b>소비 타깃층 분석:</b> 2030 직장인 및 통학 학생 비중이 70% 이상을 차지하며, 정기 방문보다는 동선 상의 충동 구매 성향이 강합니다.<br>
            • <b>객단가 특성:</b> 단품 중심의 빠른 소비가 일어나며, 1만~2만원대 트렌디 컬러렌즈 및 원데이 소포장 제품 선호도가 높습니다.
            """,
            "집객력·활성화": """
            • <b>매출 활성화도:</b> 단위 면적당 발자국(Foot Traffic)이 매우 높으며, 입구 진열 상태에 따른 결제 전환율 변동 폭이 큽니다.<br>
            • <b>시간대별 소비 집중도:</b> 퇴근 시간대(17시~20시)에 일 매출의 45% 이상이 집중되는 뚜렷한 피크 타임 특성을 보입니다.<br>
            • <b>집객 전략:</b> 원데이 렌즈 할인 행사 및 타임 세일 입간판을 전면에 노출하여 결제 전환을 극대화해야 합니다.
            """,
            "경쟁성·희소성": """
            • <b>경쟁점 밀집도:</b> 동일 지하상가 구역 내 브랜드 안경원 및 저가형 렌즈 샵이 밀집되어 있어 가격 경쟁 압박이 존재합니다.<br>
            • <b>차별화 포인트:</b> 일반 안경원과 차별화되는 렌즈미 전용 PB 라인업(트루핏, 악마원데이 등)을 전면에 내세워 단골층을 확보해야 합니다.
            """,
            "입지 안정성": """
            • <b>시설 및 계약 리스크:</b> 역사/지하상가 시설 관리 주체의 재계약 조건 및 높은 점포 임대료가 고정비 부담으로 작용할 수 있습니다.<br>
            • <b>손익 관리(BEP):</b> 고정 임대료를 상쇄할 수 있도록 원가율이 낮고 마진율이 높은 PB 컬러렌즈 판매 비중을 40% 이상으로 유지해야 합니다.
            """
        }
    elif any(k in addr_str for k in ['역', '로', '대로', '광장']) and any(k in store_name for k in ['역', '광장']):
        location_type = "초역세권/유동 중심 상권"
        scores = {"유동성·접근성": "25 / 25점", "배후 수요성": "21 / 25점", "집객력·활성화": "23 / 20점", "경쟁성·희소성": "10 / 15점", "입지 안정성": "13 / 15점"}
        details = {
            "유동성·접근성": """
            • <b>입지 특성 및 보행 동선:</b> 메인 대로변 입지로 지하철역 출입구 및 버스 정류장 접면성이 최상위 수준입니다.<br>
            • <b>가시성 및 전면 노출:</b> 전면 파사드 간판 노출도가 뛰어납니다.<br>
            • <b>접근 편의성:</b> 대중교통 이용객의 접근이 용이하여 외부 유입 고객 비중이 극대화되는 초우수 입지입니다.
            """,
            "배후 수요성": """
            • <b>배후 수요 융합도:</b> 인근 오피스 상업시설 직장인과 주말 외부 유입 인구가 복합적으로 형성되어 있습니다.<br>
            • <b>소비 연령대:</b> 20대부터 40대까지 다양하게 분포하여 미용 렌즈뿐만 아니라 기능성(난시/프리미엄) 렌즈 수요층도 풍부합니다.<br>
            • <b>구매력 특성:</b> 평균 객단가가 높게 형성될 수 있는 잠재력을 갖추고 있어 세트 판매 전략이 용이합니다.
            """,
            "집객력·활성화": """
            • <b>주중/주말 매출 균형:</b> 주중 직장인 퇴근 수요와 주말 약속/데이트 방문객 수요가 균형을 이루어 매출 기복이 적습니다.<br>
            • <b>체류 시간 및 전환율:</b> 매장 유입 인구가 많으며 체험존 구성 시 브랜드 몰입도가 극대화됩니다.<br>
            • <b>집객 전략:</b> 신상품 체험 갤러리 탭과 전면 디스플레이를 활용해 유입 유효 고객을 적극 확대해야 합니다.
            """,
            "경쟁성·희소성": """
            • <b>경쟁 과열 수준:</b> 반경 300m 내 대형 브랜드 안경원 및 렌즈 전문점이 다수 위치하여 상시 경쟁 상태입니다.<br>
            • <b>승리 전략:</b> 시력 검안 연계 서비스 및 렌즈미 독점 컬러 라인업 홍보로 맞춤형 프리미엄 전문성을 강조해야 합니다.
            """,
            "입지 안정성": """
            • <b>상권 수명 및 지속성:</b> 유동인구가 보장된 성숙 상권으로 경기 변동에 대한 탄력성이 뛰어납니다.<br>
            • <b>손익 관리:</b> 높은 임대료 비중을 극대화된 매출로 극복할 수 있도록 마진율 중심의 품목 믹스(PB+글로벌)가 필수적입니다.
            """
        }
    elif any(k in addr_str for k in ['대학', '캠퍼스']) or any(k in store_name for k in ['고대', '외대', '대', '교']):
        location_type = "대학가/1020 영타겟 상권"
        scores = {"유동성·접근성": "22 / 25점", "배후 수요성": "22 / 25점", "집객력·활성화": "20 / 20점", "경쟁성·희소성": "12 / 15점", "입지 안정성": "12 / 15점"}
        details = {
            "유동성·접근성": """
            • <b>보행 동선 특성:</b> 대학가 메인 상권 로드샵 및 등하교 핵심 동선에 위치하여 청년층 보행 유동이 집중됩니다.<br>
            • <b>가시성:</b> 트렌디한 인테리어와 전면 개방형 매대 구성 시 학생들의 매장 유입 효과가 비약적으로 증가합니다.
            """,
            "배후 수요성": """
            • <b>타깃 인구 밀도:</b> 1020세대 대학생 및 인근 자취생 밀도가 압도적으로 높아 컬러렌즈 핵심 소비층이 형성되어 있습니다.<br>
            • <b>트렌드 민감도:</b> SNS 이슈 및 연예인/인플루언서 착용 렌즈에 대한 반응 속도가 매우 빠르고 민감합니다.<br>
            • <b>가격대 선호도:</b> 1만~2만원대 가성비 컬러렌즈 및 1+1 행사 제품 구매 비중이 전체의 60% 이상을 차지합니다.
            """,
            "집객력·활성화": """
            • <b>학기 중 집객 폭발력:</b> 개강 시즌(3~6월, 9~12월) 동안 유동인구와 결제 건수가 폭발적으로 증가합니다.<br>
            • <b>비수기 변동성:</b> 여름/겨울 방학 기간(연 약 4개월) 동안 유동인구가 감소하는 계절적 특성을 보입니다.<br>
            • <b>대응 전략:</b> 학기 중 단골 고객 DB를 확보하여 방학 기간 택배 배송 및 SNS 쿠폰 이벤트를 진행해야 합니다.
            """,
            "경쟁성·희소성": """
            • <b>시장 트렌드 경쟁:</b> 유사 저가 브랜드와의 트렌드 경쟁이 치열합니다.<br>
            • <b>차별화 방안:</b> 렌즈미 고유의 인기 PB 렌즈(악마원데이, 트루핏 등)의 입소문 마케팅과 학생 할인 프로모션이 효과적입니다.
            """,
            "입지 안정성": """
            • <b>트렌드 주기 리스크:</b> 유행 주기가 빠른 영타겟 상권 특성상 매장 디스플레이 및 연출의 주기적 갱신이 필요합니다.<br>
            • <b>연간 안정성:</b> 방학 비수기 기간의 고정비 관리를 위해 방학 전 세트 판매로 매출 축적액을 확보해야 합니다.
            """
        }
    else:
        location_type = "주거 및 행정 융합 상권"
        scores = {"유동성·접근성": "18 / 25점", "배후 수요성": "23 / 25점", "집객력·활성화": "18 / 20점", "경쟁성·희소성": "13 / 15점", "입지 안정성": "14 / 15점"}
        details = {
            "유동성·접근성": """
            • <b>보행 및 차량 접근성:</b> 빠른 통행성 유동인구보다는 거주민의 목적형 정체 유동이 주를 이루며, 도보 및 자차 접근성이 안정적입니다.<br>
            • <b>동선 접면성:</b> 아파트 단지 입구, 대형 마트, 학원가, 행정복지센터 등 생활 밀착형 동선에 입지해 있습니다.
            """,
            "배후 수요성": """
            • <b>배후 거주 세대 밀도:</b> 반경 500m 내 대단지 아파트 및 주택가가 밀집되어 있어 거주민 고정 고객층이 매우 견고합니다.<br>
            • <b>소비 주체 및 객단가:</b> 초중고 학생 자녀를 둔 학부모 및 3040 거주민 비중이 높아 구매력이 일정하고 안정적입니다.<br>
            • <b>선호 제품군:</b> 미용 컬러렌즈와 함께 원데이 투명렌즈, 난시용(토릭) 렌즈, 고단가 프리미엄 제품군 수요가 높습니다.
            """,
            "집객력·활성화": """
            • <b>재방문 목적 구매:</b> 즉흥 구매 비중은 낮으나 시력 검안 및 정기 교체를 위한 단골 재방문 주기가 매우 일정합니다.<br>
            • <b>고객 충성도:</b> 한 번 확보한 고객의 타 매장 이탈률이 적어 고객 관계 관리(CRM) 시 매출 유지가 용이합니다.<br>
            • <b>객단가 증대 전략:</b> 난시 전문 검안 서비스 및 대용량 원데이 렌즈 패키지 제안으로 평균 객단가를 높여야 합니다.
            """,
            "경쟁성·희소성": """
            • <b>상권 내 독점력:</b> 동네 밀착형 중심 상권으로 추가적인 대형 브랜드 진입 가능성이 낮아 점유율 유지가 쉬운 블루오션 특성을 띱니다.<br>
            • <b>지역 밀착 마케팅:</b> 지역 커뮤니티 및 학원가 연계 모바일 쿠폰 발행으로 신규 이사 세대를 빠르게 선점할 수 있습니다.
            """,
            "입지 안정성": """
            • <b>경기 탄력성 및 방어력:</b> 경기 변동에 영향을 적게 받는 배후 주거 상권으로 매출 하락 리스크가 매우 낮습니다.<br>
            • <b>장기 점포 운영:</b> 임대료 변동 폭이 안정적이며, 장기적이고 예측 가능한 고정 수익을 창출하기에 가장 최적화된 입지입니다.
            """
        }
    ...
    if "지하상가" in location_type or "초역세권" in location_type:
        advice.append("💡 <b>[핵심 실행 전략]</b> 유동 인구가 풍부하고 즉흥 구매 성향이 높습니다. <b>트렌디한 PB/컬러렌즈 픽업 매대</b>를 입구 전면에 배치하고 행사 입간판 및 타임 세일 마케팅을 적극 활용하세요.")
    elif "대학가" in location_type:
        advice.append("💡 <b>[핵심 실행 전략]</b> 1020 세대의 트렌드 민감도가 극대화되는 입지입니다. <b>1만~2만원대 트렌디 컬러렌즈</b> 집중 구성 및 SNS 연계 프로모션으로 개강 시즌 유효 고객을 적극 선점하세요.")
    else:
        advice.append("💡 <b>[핵심 실행 전략]</b> 고정 재방문 단골 비중이 높은 안정적 상권입니다. <b>원데이 투명렌즈 및 난시용/프리미엄 렌즈 세트 세일즈</b>와 검안 연계 마케팅으로 평균 객단가를 극대화하세요.")

    if store_type in ["샵앤샵", "아이웨어샵"]:
        advice.append("👓 <b>[형태별 컨설팅]</b> 안경원 병행 매장의 이점을 살려 <b>근시/난시 정밀 시력검안 서비스</b>와 안경/렌즈 교차 구매 혜택을 제공하여 시너지를 창출하세요.")
    elif store_type == "글라스미":
        advice.append("✨ <b>[형태별 컨설팅]</b> 토탈 브랜드 매장의 메리트를 활용하여 <b>동선 유도형 진열 연출 및 고마진 PB 라인업 판매 비중</b>을 지속 확대하세요.")
    elif store_type == "단독샵":
        advice.append("🏬 <b>[형태별 컨설팅]</b> 렌즈 전문 샵의 전문성을 강조하도록 <b>체험존 강화 및 시각적 디스플레이 리뉴얼</b>을 적용해 브랜드 몰입도를 높이세요.")
    ...
    st.markdown("<p style='font-size:13px; font-weight:bold; color:#334155; margin-bottom:8px;'>👇 아래 항목 버튼을 누르시면 항목별 초디테일 평가 사유 및 실행 전략을 확인하실 수 있습니다.</p>", unsafe_allow_html=True)
    ...
    <div style="background-color:#ffffff; border:1px solid #cbd5e1; border-radius:10px; padding:20px; margin-top:12px; margin-bottom:16px; box-shadow:0 2px 8px rgba(0,0,0,0.03);">
        <div style="font-size:15px; font-weight:700; color:#4f46e5; margin-bottom:10px; border-bottom:2px solid #e2e8f0; padding-bottom:8px;">
            📌 [{active_item}] 상세 정밀 평가 사유 (점수: {scores[active_item]})
        </div>
    ...
    # 하단 컨설팅 종합 가이드 카드
    st.markdown(f"""
    <div style="font-size:13.5px; color:#1e293b; line-height:1.6; background-color:#f0fdf4; padding:16px; border-radius:8px; border:1px solid #bbf7d0; margin-bottom:24px;">
        {"<br><br>".join(advice)}
    </div>
    """, unsafe_allow_html=True)
