...
# 🧠 HTML 태그 노출 오류가 완전 수정된 상권 분석 UI 렌더링 함수
def render_location_consulting_ui(store_name, store_type, address):
    ...
    if any(k in addr_str for k in ['지하', '지하상가', '역사', '역내']):
        ...
        details = {
            ...
            * **차별화 포인트:** 일반 안경원과 차별화되는 렌즈미 전용 PB 라인업(트루핏, 악마원데이 등)을 전면에 내세워 단골층을 확보해야 합니다.
            """,
            "입지 안정성": """
        ...
        details = {
            ...
            * **승리 전략:** 시력 검안 연계 서비스 및 렌즈미 독점 컬러 라인업 홍보로 맞춤형 프리미엄 전문성을 강조해야 합니다.
            """,
            "입지 안정성": """
        ...
        details = {
            ...
            * **차별화 방안:** 렌즈미 고유의 인기 PB 렌즈(악마원데이, 트루핏 등)의 입소문 마케팅과 학생 할인 프로모션이 효과적입니다.
            """,
            "입지 안정성": """
        ...
        details = {
            ...
            * **지역 밀착 마케팅:** 지역 커뮤니티 및 학원가 연계 모바일 쿠폰 발행으로 신규 이사 세대를 빠르게 선점할 수 있습니다.
            """,
            "입지 안정성": """
    ...
    st.markdown(f"#### 📌 [{active_item}] 상세 정밀 평가 사유 (점수: {scores[active_item]})")
