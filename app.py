...
# 🧠 세부 평가 내용을 초디테일하게 보완한 상권 컨설팅 UI 함수
def render_location_consulting_ui(store_name, store_type, address):
    ...
    if any(k in addr_str for k in ['지하', '지하상가', '역사', '역내']):
        ...
        details = {
            "유동성·접근성": """
            * **보행 동선 및 흐름:** 지하철 출입구 및 역사 개찰구와 직접 연결되는 메인 통로에 접해 있어, 출퇴근시간대(08~09시, 18~20시) 유동인구 집약도가 매우 우수합니다.
            * **가시성 및 시인성:** 보행 유동 정면에 위치하여 정면 시인성은 뛰어나나, 지하 특성상 지상 입간판 설치가 제한되고 전면 노출 폭이 제한적인 단점이 있습니다.
            * **VMD 개선 솔루션:** 입구 전면에 고휘도 LED 조명이 적용된 PB/컬러렌즈 픽업 진열대를 배치하여 통행 객의 시선을 순간적으로 사로잡는 즉흥 유입 연출이 유효합니다.
            """,
            "배후 수요성": """
            * **거주/상주 수요 구조:** 반경 500m 내 주거 세대수보다 환승 및 이동 목적의 통행 유동인구 비중이 80% 이상을 차지하는 순수 이동형 상권입니다.
            * **소비 타깃층 및 성향:** 2030 출퇴근 직장인 및 통학 학생층이 주를 이루며, 정기적인 시력 검안 방문보다는 이동 중 빠르게 구매하는 충동 구매 성향이 강합니다.
            * **상품 믹스 제안:** 단품 위주의 즉각적 결제가 일어나므로 1만~2만원대 트렌디 컬러렌즈와 원데이 소포장(10P) 및 휴대용 부대용품 매대를 최우선 배치하세요.
            """,
            "집객력·활성화": """
            * **구매 전환율(CVR):** 단위 면적당 발자국(Foot Traffic)이 매우 높으며, 전면 진열 유인 요소에 따른 매장 유입 및 결제 전환율 변동 폭이 매우 큽니다.
            * **시간대별 매출 집중도:** 퇴근 시간대인 17시~20시 사이에 일 전체 매출의 50% 가까이가 집중되는 명확한 피크타임 특성을 보입니다.
            * **타깃 프로모션:** 퇴근 시간대 한정 '퇴근길 픽업 원데이 할인' 입간판을 전면 배치하여 결제 대기 시간을 줄이고 빠른 회전율을 확보하세요.
            """,
            "경쟁성·희소성": """
            * **경쟁 과열 수준:** 동일 지하상가 구역 내 저가형 안경원 및 타 브랜드 렌즈 샵이 밀집해 있어 행사 품목 간 가격 비교 압박이 지속적으로 발생합니다.
            * **차별화 솔루션:** 가격 할인전으로 맞대응하기보다 렌즈미 독점 PB 라인업(트루핏, 악마원데이)의 착용감과 독특한 그래픽 디자인을 전면에 내세워 유일성을 강조하세요.
            """,
            "입지 안정성": """
            * **계약 및 고정비 리스크:** 역사 및 지하상가 관리 주체의 주기적 입찰/재계약 이슈와 유동인구 대비 높은 임대료 비중이 고정비 부담으로 작용할 수 있습니다.
            * **손익 개선(BEP):** 고정 임대료를 안정적으로 방어하기 위해 원가율이 낮고 마진율이 높은 PB 컬러렌즈 판매 비중을 전체 매출의 45% 이상으로 상향 유지하세요.
            """
        }
        ...
        details = {
            "유동성·접근성": """
            * **보행 동선 및 흐름:** 메인 대로변 입지로 지하철역 출입구 및 버스 정류장 접면성이 최고 수준이며, 광역 유동인구의 최우선 보행 경로에 위치합니다.
            * **가시성 및 시인성:** 전면 파사드(간판) 노출 면적이 넓어 도로 건너편 및 멀리서도 렌즈미 브랜드를 한눈에 인지할 수 있는 최우수 시인성을 확보하고 있습니다.
            * **VMD 개선 솔루션:** 쇼윈도 전면에 시즌별 메인 테마 컬러렌즈 연출물과 대형 미디어 디스플레이를 활용해 상권 랜드마크 매장 이미지를 구축하세요.
            """,
            "배후 수요성": """
            * **거주/상주 수요 구조:** 인근 오피스 상업시설 직장인과 주말 외부에서 유입되는 데이트/약속 방문객이 복합적으로 형성된 초대형 융합 상권입니다.
            * **소비 타깃층 및 성향:** 20대 유행 민감층부터 3040 오피스 구매력층까지 폭넓게 분포하여 미용 렌즈는 물론 기능성/프리미엄 투명렌즈 수요도 두텁습니다.
            * **상품 믹스 제안:** 평일 퇴근길 직장인용 대용량 원데이 투명렌즈와 주말 방문객용 프리미엄 컬러렌즈 라인업을 듀얼로 메인 진열하세요.
            """,
            "집객력·활성화": """
            * **구매 전환율(CVR):** 주중 직장인 구매와 주말 외부 유입 구매가 균형을 이루어 연중 매출 기복이 적고 발자국 대비 실질 결제 전환률이 최상급입니다.
            * **시간대별 매출 집중도:** 점심시간(12~13시) 가벼운 구매와 저녁시간(18~21시) 주력 구매, 주말 오후(14~18시) 피크타임이 균일하게 분산되어 나타납니다.
            * **타깃 프로모션:** 체험존을 강화하여 매장 체류 시간을 늘리고, 렌즈 구매 시 보습 인공눈물이나 세척액 세트를 할인 제안하는 크로스셀링을 적용하세요.
            """,
            "경쟁성·희소성": """
            * **경쟁 과열 수준:** 반경 300m 내 대형 브랜드 안경원, 렌즈 전문점 및 올리브영 등 뷰티 샵이 밀집되어 유입 고객 유치 경쟁이 상시 치열합니다.
            * **차별화 솔루션:** 정밀 검안장비를 활용한 1:1 눈 건강 시력 측정 서비스와 렌즈미 멤버십 VIP 단독 할인 혜택을 강조하여 이탈을 방지하세요.
            """,
            "입지 안정성": """
            * **계약 및 고정비 리스크:** 유동 유입이 지속 보장되는 우수 입지이나, 최상위 수준으로 형성된 매장 임대료로 인해 손익분기점(BEP) 기준선이 높습니다.
            * **손익 개선(BEP):** 1회 방문당 평균 객단가(ATV)를 상향시킬 수 있도록 원데이 멀티팩 할인 및 연간권 프로모션을 적극 도입하세요.
            """
        }
        ...
        details = {
            "유동성·접근성": """
            * **보행 동선 및 흐름:** 대학가 메인 상권 로드샵 및 등하교 핵심 보행 동선에 위치하여 1020세대 청년층의 보행 유동이 집중되는 구조입니다.
            * **가시성 및 시인성:** 트렌디한 매장 전면 구성 시 보행 중인 학생들의 매장 유입 효과가 비약적으로 상승하나, 이동 속도가 빨라 단시간에 시선을 사로잡아야 합니다.
            * **VMD 개선 솔루션:** 입구 근처에 학생들의 발걸음을 멈추게 하는 개방형 팝업 거울 매대와 포토존 조명을 설치하세요.
            """,
            "배후 수요성": """
            * **거주/상주 수요 구조:** 1020세대 대학생 및 인근 자취 거주민 밀도가 압도적으로 높아 컬러렌즈의 핵심 소비층이 완벽히 형성되어 있습니다.
            * **소비 타깃층 및 성향:** SNS 이슈 및 연예인/인플루언서 착용 렌즈에 대한 반응 속도가 매우 빠르나, 가성비 제품 선호도가 높아 평균 객단가는 다소 낮습니다.
            * **상품 믹스 제안:** 1만~2만원대 가성비 컬러렌즈와 1+1, 1+2 팩 렌즈 프로모션 구성을 전면에 내세워 학생 고객의 부담을 줄이세요.
            """,
            "집객력·활성화": """
            * **구매 전환율(CVR):** 개강 시즌(3~6월, 9~12월) 동안 유동인구와 구매 전환율이 폭발적으로 증가하는 특성을 보입니다.
            * **시간대별 매출 집중도:** 공강 시간대인 13~15시와 하교 시간대인 17~19시 사이에 매출이 집약적으로 발생합니다.
            * **타깃 프로모션:** 방학 비수기(여름/겨울 연 4개월) 유동 감소에 대비해 학기 중 단골 DB를 확보하고 방학 중 택배 배송 이벤트를 안내하세요.
            """,
            "경쟁성·희소성": """
            * **경쟁 과열 수준:** 대학가 내 유사 저가 미용 렌즈 브랜드들과의 트렌드 선점 및 가격 프로모션 경쟁이 상시 공존합니다.
            * **차별화 솔루션:** 숏폼/인스타그램에서 화제가 되는 컬러 렌즈를 가장 전면에 즉시 진열하고 대학 총학생회 제휴 제휴 할인을 추진하세요.
            """,
            "입지 안정성": """
            * **계약 및 고정비 리스크:** 유행 주기가 빠른 영타겟 상권 특성상 기존 인기 상품의 수명이 짧아 디스플레이 갱신 소모 비용이 지속 발생합니다.
            * **손익 개선(BEP):** 학기 중 축적된 고마진 PB 매출을 통해 방학 비수기의 고정비를 안정적으로 방어할 수 있도록 연간 예산을 분배하세요.
            """
        }
    else:
        ...
        details = {
            "유동성·접근성": """
            * **보행 동선 및 흐름:** 빠른 통행성 유동인구보다는 거주민의 정체형 도보 동선 위주로, 아파트 단지 입구 및 생활 밀착형 상가에 접해 있습니다.
            * **가시성 및 시인성:** 도보 접근성이 안정적이며, 차량 방문 고객을 위한 건물 주차 및 접근 편의성이 양호한 편입니다.
            * **VMD 개선 솔루션:** 주차 이용 안내 및 정밀 검안 전문 안경원 이미지를 전달할 수 있는 외관 연출을 적용하세요.
            """,
            "배후 수요성": """
            * **거주/상주 수요 구조:** 반경 500m 내 대단지 아파트 및 주택가가 밀집해 있어 거주민 중심의 고정 단골 고객층 배후가 매우 견고합니다.
            * **소비 타깃층 및 성향:** 초중고 학생 자녀를 둔 학부모 및 3040 거주민 비중이 높아 일정한 구매력을 갖추고 있으며 충성도가 높습니다.
            * **상품 믹스 제안:** 미용 컬러렌즈와 더불어 원데이 투명렌즈, 난시용(토릭) 렌즈, 대용량 패키지 및 고단가 프리미엄 제품을 함께 구성하세요.
            """,
            "집객력·활성화": """
            * **구매 전환율(CVR):** 즉흥 유입 구매 비중은 낮으나 시력 검안 및 정기 교체를 위한 단골 재방문 목적 구매 비율이 높아 결제 전환율이 매우 높습니다.
            * **시간대별 매출 집중도:** 하교 시간대인 16~18시(학생층)와 저녁 장보기 시간대인 18~20시(주부/직장인층)에 안정적으로 분산됩니다.
            * **타깃 프로모션:** 단골 고객의 렌즈 교체 주기에 맞춘 자동 교체 알림 CRM 문자 발송 및 거주민 단독 케어 혜택을 제공하세요.
            """,
            "경쟁성·희소성": """
            * **경쟁 과열 수준:** 동네 밀착형 상권으로 신규 대형 경쟁점의 유입 가능성이 낮아 상권 내 점유율을 독점하기에 매우 유리합니다.
            * **차별화 솔루션:** 지역 맘카페 및 당근마켓 동네생활 등 지역 커뮤니티 이벤트를 활용해 이사 온 신규 세대를 빠르게 선점하세요.
            """,
            "입지 안정성": """
            * **계약 및 고정비 리스크:** 경기 변동이나 외부 이슈에 영향을 적게 받는 배후 주거지로, 매출 하락 리스크가 매우 적습니다.
            * **손익 개선(BEP):** 임대료 변동 폭이 안정적이며 고정 단골을 바탕으로 고마진 PB 라인업을 지속 확대하여 점포 순이익률을 극대화하세요.
            """
        }
    ...
    st.markdown("<p style='font-size:13px; font-weight:bold; color:#334155; margin-bottom:8px;'>👇 아래 항목 버튼을 누르시면 세부 정밀 평가 내용 및 개선 솔루션을 확인하실 수 있습니다.</p>", unsafe_allow_html=True)
    ...
    # 📌 하단 컨설팅 리포트 (형태별 컨설팅 하단에 오렌즈 2줄 비교 노출)
