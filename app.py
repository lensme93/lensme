...
def render_location_consulting_ui(store_name, store_type, address):
    ...
    if any(k in addr_str for k in ['지하', '지하상가', '역사', '역내']):
        ...
        details = {
            ...
            * **가시성 및 시인성:** 보행 동선 정면에 위치하여 접근성은 뛰어난 편이나, 지하 구조의 한계로 인해 지상 전면 노출 및 간판 시인성은 제한적입니다.
            * **VMD 개선 솔루션:** 입구 전면에 고휘도 LED 조명이 적용된 PB/컬러렌즈 픽업 진열대를 배치하여 통행 객의 시선을 순간적으로 사로잡는 연출이 유효합니다.
            """,
            "배후 수요성": """
            * **배후 거주 세대:** 반경 500m 내 주거 세대수보다 통행 유동인구 비중이 80% 이상을 차지하는 이동형 상권입니다.
            * **소비 타깃층 분석:** 2030 직장인 및 통학 학생 비중이 높으며, 정기 방문보다는 동선 상의 충동 구매 성향이 강하게 나타납니다.
            * **상품 믹스 제안:** 단품 위주의 빠른 결제가 일어나므로 1만~2만원대 트렌디 컬러렌즈 및 원데이 소포장(10P) 제품을 최우선배치하세요.
            """,
            "집객력·활성화": """
            * **매출 활성화도:** 단위 면적당 발자국(Foot Traffic)이 매우 높으며, 전면 진열 유인 요소에 따른 결제 전환율 변동 폭이 높습니다.
            * **시간대별 소비 집중도:** 퇴근 시간대(17시~20시)에 일 전체 매출의 50% 가까이가 집중되는 뚜렷한 피크 타임 특성을 보입니다.
            * **집객 전략:** 퇴근 시간대 한정 '퇴근길 픽업 원데이 할인' 입간판을 전면 배치하여 결제 대기 시간을 줄이고 빠른 회전율을 확보하세요.
            """,
            "경쟁성·희소성": """
            * **경쟁점 밀집도:** 동일 지하상가 구역 내 저가형 안경원 및 타 브랜드 렌즈 샵이 밀집되어 있어 가격 경쟁 압박이 존재합니다.
            * **차별화 솔루션:** 가격 할인전으로 맞대응하기보다 렌즈미 독점 PB 라인업(트루핏, 악마원데이)의 차별화된 그래픽 디자인을 강조하세요.
            """,
            "입지 안정성": """
            * **계약 및 고정비 리스크:** 역사 및 지하상가 관리 주체의 재계약 이슈와 높게 형성된 임대료 비율이 고정비 부담 요인입니다.
            * **손익 개선(BEP):** 고정 임대료를 방어하기 위해 원가율이 낮고 마진율이 높은 PB 컬러렌즈 판매 비중을 45% 이상으로 상향 유지하세요.
            """
        }
        ...
        details = {
            "유동성·접근성": """
            * **입지 특성 및 보행 동선:** 메인 대로변 입지로 지하철역 출입구 및 버스 정류장 접면성이 최고 수준이며 광역 유동인구의 중심 동선에 위치합니다.
            * **가시성 및 시인성:** 전면 파사드 간판 노출 면적이 넓어 도로 건너편 및 멀리서도 렌즈미 브랜드를 한눈에 인지할 수 있습니다.
            * **VMD 개선 솔루션:** 쇼윈도 전면에 시즌별 메인 테마 컬러렌즈 연출물과 대형 미디어 디스플레이를 활용해 랜드마크 이미지를 구축하세요.
            """,
            "배후 수요성": """
            * **배후 수요 융합도:** 오피스 직장인과 주말 외부 유입 인구가 복합되어 20대부터 40대까지 소비층이 광범위하게 분포합니다.
            * **소비 성향:** 미용 렌즈뿐만 아니라 기능성/프리미엄 투명렌즈 수요도 두터워 고단가 세트 판매가 용이합니다.
            * **상품 믹스 제안:** 평일 퇴근길 직장인용 대용량 원데이 투명렌즈와 주말 방문객용 프리미엄 컬러렌즈 라인업을 듀얼 진열하세요.
            """,
            "집객력·활성화": """
            * **매출 활성화도:** 주중 직장인 구매와 주말 외부 유입 구매가 균형을 이루어 연중 매출 기복이 적고 결제 전환률이 최상급입니다.
            * **시간대별 매출 집중도:** 점심시간(12~13시) 가벼운 구매, 저녁시간(18~21시) 주력 구매, 주말 오후(14~18시) 피크타임이 균일하게 형성됩니다.
            * **집객 전략:** 체험존을 강화해 체류 시간을 늘리고, 렌즈 구매 시 보습 인공눈물이나 세척액 할인 증정을 연계하세요.
            """,
            "경쟁성·희소성": """
            * **경쟁 과열 수준:** 반경 300m 내 대형 브랜드 안경원, 렌즈 전문점 및 뷰티 샵이 밀집되어 고객 유치 경쟁이 치열합니다.
            * **차별화 솔루션:** 정밀 검안장비를 활용한 1:1 눈 건강 시력 측정 서비스와 렌즈미 멤버십 VIP 단독 혜택으로 단골을 이탈 방지하세요.
            """,
            "입지 안정성": """
            * **계약 및 고정비 리스크:** 유동 유입이 보장되는 입지이나, 최상위 수준의 임대료로 인해 손익분기점(BEP) 기준선이 높은 편입니다.
            * **손익 개선(BEP):** 평균 객단가를 상향시킬 수 있도록 원데이 멀티팩 할인 및 연간권 프로모션을 적극 도입하세요.
            """
        }
        ...
        details = {
            "유동성·접근성": """
            * **입지 특성 및 보행 동선:** 대학가 메인 로드샵 및 등하교 핵심 보행 동선에 위치하여 청년층 보행 유동이 집중되는 구조입니다.
            * **가시성 및 시인성:** 전면 개방형 매대 구성 시 학생 유입 효과가 높으나, 보행 이동 속도가 빨라 단시간에 시선을 잡아끌어야 합니다.
            * **VMD 개선 솔루션:** 입구 근처에 개방형 팝업 거울 매대와 학생 선호 포토존 조명을 설치하세요.
            """,
            "배후 수요성": """
            * **타깃 인구 밀도:** 1020세대 대학생 및 자취 거주민 밀도가 압도적이어서 미용 컬러렌즈 핵심 소비층이 완벽히 형성되어 있습니다.
            * **소비 성향:** SNS 이슈 및 연예인/인플루언서 착용 렌즈에 대한 반응 속도가 매우 빠르나 가성비 제품 선호도가 높습니다.
            * **상품 믹스 제안:** 1만~2만원대 가성비 컬러렌즈와 1+1, 1+2 팩 렌즈 프로모션 구성을 전면에 내세우세요.
            """,
            "집객력·활성화": """
            * **매출 활성화도:** 개강 시즌(3~6월, 9~12월) 동안 유동인구와 구매 전환율이 폭발적으로 증가하는 특성을 보입니다.
            * **시간대별 매출 집중도:** 공강 시간대인 13~15시와 하교 시간대인 17~19시 사이에 매출이 집약적으로 발생합니다.
            * **비수기 대응 솔루션:** 학기 중 단골 DB를 확보해 방학 비수기(여름/겨울 연 4개월) 동안 택배 배송 이벤트를 안내하세요.
            """,
            "경쟁성·희소성": """
            * **경쟁 과열 수준:** 대학가 내 유사 저가 미용 렌즈 브랜드들과의 트렌드 선점 및 가격 프로모션 경쟁이 상시 공존합니다.
            * **차별화 솔루션:** 숏폼/인스타그램에서 화제가 되는 컬러 렌즈를 가장 전면에 즉시 진열하고 대학 총학생회 제휴 할인을 활용하세요.
            """,
            "입지 안정성": """
            * **계약 및 고정비 리스크:** 유행 주기가 빠른 영타겟 상권 특성상 기존 인기 상품의 수명이 짧아 연출 교체 비용이 발생합니다.
            * **손익 개선(BEP):** 학기 중 축적된 고마진 PB 매출을 통해 방학 비수기의 고정비를 방어할 수 있도록 연간 예산을 분배하세요.
            """
        }
    else:
        ...
        details = {
            ...
            * **소비 타깃층 분석:** 초중고 학생 자녀를 둔 학부모 및 3040 거주민 비중이 높아 일정한 구매력을 갖추고 있으며 충성도가 높습니다.
    ...
    st.markdown("<p style='font-size:13px; font-weight:bold; color:#334155; margin-bottom:8px;'>👇 아래 항목 버튼을 누르시면 세부 평가 사유를 확인하실 수 있습니다.</p>", unsafe_allow_html=True)
